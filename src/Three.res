...
@send external lerpVector3: (vector3, vector3, float) => vector3 = "lerp"
...
@get external getUp: 'a => vector3 = "up"
...
// Restores the position, up-vector, and zoom captured when the controls were
// constructed.
@send external resetTrackballControls: trackballControls => unit = "reset"
